...
resource "azurerm_storage_account" "functions" {
  name                     = "st${local.project_prefix}func36ed"  # Unique suffix
...
resource "azurerm_postgresql_flexible_server" "main" {
  ...
  # zone removed - let Azure pick available zone
...
# Note: Consumption plans created via CLI get auto-generated names
resource "azurerm_service_plan" "functions" {
  name                = "WestEuropeLinuxDynamicPlan"  # Auto-generated by Azure CLI
  location            = azurerm_resource_group.main.location
  resource_group_name = azurerm_resource_group.main.name
  os_type             = "Linux"
  ...
  lifecycle {
    ignore_changes = [name]  # Name was auto-generated
  }
}
