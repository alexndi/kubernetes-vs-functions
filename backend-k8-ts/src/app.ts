...
app.get('/api/posts/:category', authMiddleware.authenticateToken, async (req: Request, res: Response) => {
  try {
    ...
    console.log(`Fetching posts for category: ${category}, authenticated: ${req.isAuthenticated}`);
...
app.get('/api/user/profile', authMiddleware.authenticateToken, authMiddleware.requireAuth, (req: Request, res: Response) => {
...
app.get('/api/admin/users', authMiddleware.authenticateToken, authMiddleware.requireRole('admin'), (req: Request, res: Response) => {
  res.json({
